...
export const openSource = [
  {
    name: "Quizzer",
    description:
      "Online quiz platform built as a Modular Monolith — module boundaries without microservice overhead.",
  ...
  },
  {
    ...
    description:
      "Hotel management application spanning Blazor Server, Blazor WASM, and ASP.NET Core APIs.",
  ...
  },
  {
    name: "UrlShortener",
    description:
      "URL shortener demonstrating EF Core with PostgreSQL — compact, focused reference implementation.",
