...
export default function ScrollIdentity() {
  ...
  return (
    ...
    >
      <div className="w-fit rounded-2xl border border-line bg-panel/80 p-4 text-center shadow-xl shadow-[color-mix(in_srgb,var(--g2)_10%,transparent)] backdrop-blur">
        ...
        <a
          ...
          className="mt-3 block font-mono text-[11px] whitespace-nowrap text-mut transition-colors hover:text-vio"
        >
          {links.email}
        </a>
      </div>
